...
const PerfilDocente = () => {
    const { perfil } = useSelector((state) => state) // Cambia aquí según tu store
            ...
            <CCardBody>
                ...
                <CRow className="ms-3 me-3">
                    ...
                    <CCol md={3}>
                        ...
                        <p>
                            <strong>Otra Facultad:</strong> {perfil.otherFaculty || 'No especificado'}
                        </p>
                    </CCol>
                    ...
                    <CCol md={3}>
                        ...
                        <p>
                            <strong>Rol:</strong> {perfil.rol ? 'Docente' : ''}
                        </p>
                    </CCol>
